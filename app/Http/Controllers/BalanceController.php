...
class BalanceController extends Controller
{
    ...
    public function balance(Request $request){
        ...
        */
        ...
        $balance_on_us =  TransactionType::where('name','BALANCE_ON_US')->get()->first()->id;
       /*
        ...
        */
        ...
        $fees_charged = FeesCalculatorService::calculateFees(
            ...
            $revenue = Wallet::where('mobile',Accounts::find(8)->account_number)->first();
           ...
           $available_balance = round($source->balance,2,PHP_ROUND_HALF_EVEN) * 100;
        ...
        if (isset($request->imei)) {
            ...
            try {
                ...
                if ($balance_response->available_balance < $fees_result['minimum_balance']) {
                    ...
                    $account_debit = array('serial_no'         => '472100',
                                           'our_branch_id'      => $branch_id,
                                           'account_id'        => $request->account_number,
                                           'trx_description_id' => '007',
                                           'trx_description'   => 'Balance enquiry on us,debit fees',
                                           'trx_amount'        => '-' . $fees_result['fees_charged']);

                    $bank_revenue_credit = array('serial_no'         => '472100',
                                                 'our_branch_id'      => $branch_id,
    ...
    public function balance_off_us(Request $request){
        ...
        $branch_id = substr($request->account_number, 0, 3);
        $currency = License::find(1);
        $balance_off_us =  TransactionType::where('name','BALANCE_ENQUIRY_OFF_US')->get()->first()->id;
        ...
        if(isset($card_details->wallet_id)){
            ...
            $source->lockForUpdate()->first();
            if($total_deductions > $fees_charged['minimum_balance']){

                WalletTransactions::create([

                    'txn_type_id'         => $balance_off_us,
                    'tax'                 => '0.00',
                    'revenue_fees'        => $fees_charged['fees_charged'],
                    'interchange_fees'    => '0.00',
            ...
            $revenue = Wallet::where('mobile',Accounts::find(8)->account_number)->first();
            $zimswitch_account = Wallet::where('mobile',Accounts::find(9)->account_number)->first();
        ...
        try {
            ...
            if ($balance_response->available_balance < $fees_result['minimum_balance']) {
                ...
                $account_debit = array('serial_no'         => '472100',
                                       ...
                                       'trx_description_id' => '007',
                                       'trx_description'   => 'Balance enquiry attempt,Debit penalty fees',
                                       'trx_amount'        => '-' . $fees_result['fees_charged']);
                ...
                $credit_zimswitch = array('serial_no'         => '472100',
                                          ...
                                          'trx_description_id' => '008',
                                          'trx_description'   => "Balance enquiry attempt,Zimswitch Account Credit ",
                ...
                $account_debit = array('serial_no'         => '472100',
                                       ...
                                       'AccountID'        => $request->account_number,
                                       'trx_description_id' => '007',
                                       'trx_description'   => 'Balance Fees Debit',
                                       'trx_amount'        => '-' . $fees_result['fees_charged']);
                ...
                $credit_zimswitch = array('serial_no'         => '472100',
                                          ...
                                          'AccountID'        => $zimswitch_account->account_number,
                                          'trx_description_id' => '008',
                                          'trx_description'   => "Zimswitch Revenue Account Credit",
                                          'trx_amount'        => $fees_result['zimswitch_fee']);
