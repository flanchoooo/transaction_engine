        ...
        if ($result === 'TRUE'){
            ...
            if ($result['code'] == '00'){
                ...
                if(isset($request->imei)){
                    ...
                    $destination_account_credit = array('serial_no'         => '472100',
                        'our_branch_id'      => substr($account_number, 0, 3),
                        'account_id'        => $account_number,
                        'trx_description_id' => '007',
                        'trx_description'   => 'ZIPIT RECEIVE',
                        'trx_amount'        => $request->amount);




                    $deposit_account_debit = array('serial_no'         => '472100',
                        'our_branch_id'      => '001',
                        'account_id'        => $deposit_account->account_number,
                        'trx_description_id' => '008',
                        'trx_description'   => 'ZIPIT CREDIT SUSPENSE ACCOUNT',
                        'trx_amount'        => -$request->amount);
