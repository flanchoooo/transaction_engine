                    ...
                    foreach ($status as $state){
                        ...
                        if ($account == '0'){
                            ...
                            $account_debit = array('serial_no'         => '472100',
                                ...
                                'trx_description'   => 'CARD-SWIPE',
                                'trx_amount'        => -$request->amount);

                            $account_debit_fees = array('serial_no'         => '472100',
                                'our_branch_id'      => substr($account_number, 0, 3),
                                'AccountID'        => $account_number,
                                'trx_description_id' => '007',
                                'trx_description'   => "Transfer Fees Debit",
                                'trx_amount'        => '-' . $fees_result['fees_charged']);

                            $destination_credit_zimswitch = array('serial_no'         => '472100',
                                'our_branch_id'      => '001',
                            ...
                            $bank_revenue_credit = array('serial_no'         => '472100',
                                ...
                                'trx_description_id' => '008',
                                'trx_description'   => "Revenue Account Credit",
                                'trx_amount'        => $fees_result['fee']);
