...
class PurchaseOffUsController extends Controller
{
    ...
    public function purchase_off_us_prod(Request $request)
    {
    ...
    public function purchase_off_us(Request $request)
    {
        ...
        if ($source_account_number == '263'){
             ...
             try {
                 ...
                 $auto_deduction->description = "WALLET | Tax settlement | $request->rrn |  $request->account_number |  $reference";
                 $auto_deduction->save();
                 ...
                 $auto_deduction->destination_account = REVENUE;
                 $auto_deduction->txn_status = 'WALLET PENDING';
                 $auto_deduction->description = "WALLET | Revenue settlement | $request->rrn |  $request->account_number |  $reference";
                 $auto_deduction->save();
                 ...
                 $auto_deduction->destination_account = ZIMSWITCH;
                 $auto_deduction->txn_status = 'WALLET PENDING';
                 $auto_deduction->description = "WALLET | Zimswitch settlement | $request->rrn |  $request->account_number |  $reference";
                 $auto_deduction->save();
